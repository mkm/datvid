...
\section{Indledning}
Nu til dags er båndbredden over netværk højere end båndbredden til en lokal harddisk, eller er det? Vi vil udføre et eksperiment for at se om udsagnet er sandt.
